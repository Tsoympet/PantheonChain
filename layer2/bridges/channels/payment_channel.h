...
struct ChannelBalance {
    ...
    ChannelBalance(uint64_t t, uint64_t d, uint64_t o) : taln(t), drm(d), obl(o) {}
};
...
class PaymentChannel {
  public:
    ...
    bool UpdateState(const ChannelBalance& new_balance_a, const ChannelBalance& new_balance_b,
                     uint64_t new_sequence, const std::vector<uint8_t>& signature_a,
