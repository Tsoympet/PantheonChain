...
std::array<uint8_t, 32> PlasmaChain::BuildMerkleRoot(
    const std::vector<std::array<uint8_t, 32>>& tx_hashes) const
{
...
bool PlasmaChain::ChallengeExit(
...
bool PlasmaChain::VerifyMerkleProof(
    const std::array<uint8_t, 32>& tx_hash,
...
PlasmaOperator::PlasmaOperator(PlasmaChain* chain)
    : chain_(chain)
{
}
