...
public:
     ...
     */
    static std::vector<uint8_t> CreatePool(
        primitives::AssetID asset_a,
        primitives::AssetID asset_b,
        uint64_t initial_a,
        uint64_t initial_b,
     ...
     */
    static std::pair<uint64_t, uint64_t> RemoveLiquidity(
        const std::vector<uint8_t>& pool_id,
        uint64_t shares,
        const std::vector<uint8_t>& provider_pubkey
    );
     ...
     */
    static uint64_t GetOutputAmount(
        uint64_t input_amount,
...
public:
     ...
     */
    std::vector<Trade> ExecuteMarketOrder(
