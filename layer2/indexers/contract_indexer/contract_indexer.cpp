...
void ContractIndexer::IndexContractDeployment(
    const std::array<uint8_t, 20>& address,
    const std::vector<uint8_t>& code,
    uint32_t height
) {
...
std::vector<ContractEvent> ContractIndexer::GetEventsByContract(
    const std::array<uint8_t, 20>& contract_address,
    uint32_t limit
) {
...
std::vector<ContractEvent> ContractIndexer::GetEventsByTopic(
    const std::array<uint8_t, 32>& topic,
    uint32_t limit
) {
...
std::optional<ContractIndexer::ContractInfo> ContractIndexer::GetContractInfo(
    const std::array<uint8_t, 20>& address
) {
