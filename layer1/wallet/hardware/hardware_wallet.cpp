...
public:
    ...
    std::optional<std::vector<uint8_t>> GetPublicKey(
    ...
    std::optional<std::string> GetAddress(
        const DerivationPath& path,
        bool display_on_device
    ) override {
    ...
    std::optional<primitives::Transaction> SignTransaction(
