...
STARKProof STARKProver::ProveStatement([[maybe_unused]] const std::vector<uint8_t>& witness,
...
STARKProver::BuildMerkleTree([[maybe_unused]] const std::vector<std::vector<uint64_t>>& trace) {
...
std::vector<uint8_t>
STARKProver::FRIProtocol([[maybe_unused]] const std::vector<std::vector<uint64_t>>& polynomial) {
