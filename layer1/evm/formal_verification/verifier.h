...
public:
     ...
     */
    VerificationResult VerifyContract(
     ...
     */
    VerificationResult VerifySource(
...
public:
     ...
     */
    std::vector<std::string> FindAssertionViolations(
        const std::vector<uint8_t>& bytecode
    );
     ...
     */
    std::vector<std::vector<uint8_t>> GenerateTestCases(
        const std::vector<uint8_t>& bytecode
    );
};
...
public:
     ...
     */
    static bool UpgradeImplementation(
        Proxy& proxy,
     ...
     */
    static bool VerifyUpgradeSafety(
...
public:
     ...
     */
    static std::vector<StorageSlot> AnalyzeLayout(
        const std::vector<uint8_t>& bytecode
    );
     ...
     */
    static bool AreLayoutsCompatible(
     ...
     */
    static std::vector<std::string> DetectCollisions(
