// ParthenonChain - EVM Opcodes Definition
// Full EVM opcode set for OBOLOS smart contracts
 ...
 */
inline bool IsPushOp(Opcode op) {
    return static_cast<uint8_t>(op) >= 0x60 && static_cast<uint8_t>(op) <= 0x7f;
}
 ...
 */
inline bool IsSwapOp(Opcode op) {
