...
std::optional<Schnorr::Signature> Schnorr::Sign(const PrivateKey& privkey, const uint8_t* msg_hash,
...
bool Schnorr::Verify(const PublicKey& pubkey, const uint8_t* msg_hash, const Signature& signature) {
