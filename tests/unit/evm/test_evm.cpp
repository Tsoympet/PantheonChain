...
void TestArithmetic() {
    ...
    std::vector<uint8_t> code = {
        static_cast<uint8_t>(Opcode::PUSH1), 0x0A,  // Push 10
...
void TestMemoryOperations() {
    ...
    std::vector<uint8_t> code = {
        static_cast<uint8_t>(Opcode::PUSH1), 0x2A,  // Push 42
...
void TestStorageOperations() {
    ...
    std::vector<uint8_t> code = {
        static_cast<uint8_t>(Opcode::PUSH1), 0x63,  // Push 99
...
void TestBitwise() {
    ...
    std::vector<uint8_t> code = {
        static_cast<uint8_t>(Opcode::PUSH1), 0xFF,  // Push 255
...
void TestGasMetering() {
    ...
    std::vector<uint8_t> code = {
        static_cast<uint8_t>(Opcode::PUSH1), 0x63,
        static_cast<uint8_t>(Opcode::PUSH1), 0x01,
