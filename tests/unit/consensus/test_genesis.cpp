...
void TestExpectedGenesisHashes() {
    const auto mainnet_expected = MakeHash(
        {0x66, 0x01, 0x89, 0xb8, 0x46, 0x6f, 0xa2, 0x95, 0x7f, 0x0a, 0x8b, 0xf9, 0xbb,
         0xe6, 0xfd, 0xda, 0x5c, 0xc4, 0xeb, 0x79, 0xae, 0x57, 0xf2, 0x41, 0x61, 0xdf,
         0x72, 0x6c, 0xee, 0x4b, 0x85, 0x44});
    const auto testnet_expected = MakeHash(
        {0xfe, 0x73, 0x9e, 0x3c, 0x1e, 0x27, 0x50, 0x9a, 0x9c, 0x7d, 0x22, 0x60, 0xe3,
         0x94, 0x38, 0xf1, 0xff, 0x1c, 0x44, 0xdc, 0x03, 0xa6, 0x30, 0x9e, 0x68, 0x73,
         0x7b, 0x2c, 0xc6, 0x2c, 0x38, 0x75});
    const auto regtest_expected = MakeHash(
        {0xf8, 0x5d, 0x0b, 0xad, 0x36, 0xaf, 0xae, 0x82, 0xec, 0x8b, 0x2c, 0x60, 0xa9,
         0x58, 0x7a, 0xb2, 0xd3, 0x65, 0x81, 0xb4, 0xea, 0x31, 0xa1, 0x08, 0xb7, 0xcc,
         0xfe, 0xfb, 0x97, 0x76, 0xbc, 0x15});
