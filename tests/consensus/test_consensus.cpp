...
void TestSupplyCapEnforcement() {
    ...
    std::cout << "  ✅ TALANTON: " << tal_total / AssetSupply::BASE_UNIT
              << " <= " << tal_max / AssetSupply::BASE_UNIT << std::endl;
    std::cout << "  ✅ DRACHMA: " << dra_total / AssetSupply::BASE_UNIT
              << " <= " << dra_max / AssetSupply::BASE_UNIT << std::endl;
    std::cout << "  ✅ OBOLOS: " << obl_total / AssetSupply::BASE_UNIT
              << " <= " << obl_max / AssetSupply::BASE_UNIT << std::endl;
}
...
void TestCoinbaseValidation() {
    ...
    std::cout << "  ✅ Maximum TALANTON coinbase: " << max_tal_reward / AssetSupply::BASE_UNIT
              << " TAL" << std::endl;
