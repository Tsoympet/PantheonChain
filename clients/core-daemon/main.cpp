...
public:
    static Config Parse(const std::string& filepath) {
        ...
        while (std::getline(file, line)) {
            ...
            if (key == "network.port") config.network_port = std::stoi(value);
            else if (key == "network.max_connections") config.max_connections = std::stoi(value);
            else if (key == "network.timeout") config.network_timeout = std::stoi(value);
            else if (key == "rpc.enabled") config.rpc_enabled = (value == "true" || value == "1");
            else if (key == "rpc.port") config.rpc_port = std::stoi(value);
            ...
            else if (key == "mining.enabled") config.mining_enabled = (value == "true" || value == "1");
        }
