...
void ReceivePage::setupUI() {
    ...
    QLabel *instructionsLabel = new QLabel(
        tr("Share your address with others to receive payments.\n"
           "Each address can be used multiple times."), this);
...
void ReceivePage::onGenerateAddress() {
    ...
    QString newAddress = QString("parthenon1q%1").arg(
        QDateTime::currentMSecsSinceEpoch() % 1000000000, 9, 10, QChar('0'));
