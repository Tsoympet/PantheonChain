...
public:
    RPCClient(const std::string& host, int port, const std::string& user, const std::string& password)
    ...
    std::string Call(const std::string& method, const std::vector<std::string>& params) {
        ...
        if (method == "getinfo") {
            ...
            result += "{\"txid\": \"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\"}";
        } else if (method == "stop") {
