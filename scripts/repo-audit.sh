...
required_dirs=(
  ...
  layer1-talanton/ledger
  layer1-talanton/tx
  layer1-talanton/rpc
  layer1-talanton/params
  layer1-talanton/genesis
  layer1-talanton/tests
  layer1-talanton/docs
  layer2-drachma/node
  layer2-drachma/consensus
  layer2-drachma/staking
  layer2-drachma/payments
  layer2-drachma/bridge-l1
  layer2-drachma/tx
  layer2-drachma/rpc
  layer2-drachma/params
  layer2-drachma/genesis
  layer2-drachma/tests
  layer2-drachma/docs
  layer3-obolos/node
  layer3-obolos/consensus
  layer3-obolos/staking
  layer3-obolos/evm
  layer3-obolos/gas
  layer3-obolos/bridge-l2
  layer3-obolos/tx
  layer3-obolos/rpc
  layer3-obolos/params
  layer3-obolos/genesis
  layer3-obolos/tests
  layer3-obolos/docs
  common/crypto
  common/p2p
